...
const Footer = () => {
  return (
    <div>
      <footer className=" bg-white  pt-1 border-b-2 bottom-0 border-yellow-500">
            ...
            <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
              <div className="flex flex-col">
                ...
                <span className="flex space-x-4">
                  <svg
                    ...
                    className="h-5 w-5 stroke-current text-yellow-500 "
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
              ...
              <div className="flex flex-col">
                ...
                <span className="flex space-x-4 ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 stroke-current text-yellow-500 "
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <span className="flex space-x-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5  stroke-current text-yellow-400"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
            ...
            <div className="sm:w-2/3 flex space-x-20 items-center text-center py-6">
              ...
              <div className=" flex text-yellow  space-x-4   ">
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-facebook text-yellow-400 "
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-twitter text-yellow-400"
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-linkedin text-yellow-400"
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-instagram text-yellow-400"
                  viewBox="0 0 16 16"
                >
